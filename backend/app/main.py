...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://localhost:3000",
        "http://localhost:3001",
        "https://influract.vercel.app",
        "https://frontend-jrnzjc53s-priyansharora1804-gmailcoms-projects.vercel.app",
        "https://frontend-bww9a5p88-priyansharora1804-gmailcoms-projects.vercel.app",
    ],
